...
function vw_ecommerce_store_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'vw_ecommerce_store_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/wordpress-ecommerce-theme/">GO PRO</a>','vw-ecommerce-store'),
		'panel' => 'vw_ecommerce_store_panel_id'
	));
	...
	$wp_customize->add_section( 'vw_ecommerce_store_sale' , array(
    	...
    	'description' => __('For more options sale banner section</br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/wordpress-ecommerce-theme/">GO PRO</a>','vw-ecommerce-store'),
		'panel' => 'vw_ecommerce_store_panel_id'
	));
	...
	$wp_customize->add_section( 'vw_ecommerce_store_services_section' , array(
    	...
    	'description' => __('For more options our best seller section</br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/wordpress-ecommerce-theme/">GO PRO</a>','vw-ecommerce-store'),
		'priority'   => null,
		'panel' => 'vw_ecommerce_store_panel_id'
	));
	...
	$wp_customize->add_section('vw_ecommerce_store_footer',array(
		...
		'description' => __('For more options our footer section</br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/wordpress-ecommerce-theme/">GO PRO</a>','vw-ecommerce-store'),
		'panel' => 'vw_ecommerce_store_panel_id',
	));	
