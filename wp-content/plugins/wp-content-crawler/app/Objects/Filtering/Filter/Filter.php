...
class Filter implements Verbosable {
     ...
     * @since 1.11.0
     */
    public function __construct($condition, ?array $actions, ?string $actionEventKey = null,
     ...
     * @since 1.11.0
     */
    public function executeActions(FilterDependencyProvider $provider) {
     ...
     * @since 1.11.0
     */
    protected function maybeExecuteNotExecutedConditionActions(FilterDependencyProvider $provider) {
