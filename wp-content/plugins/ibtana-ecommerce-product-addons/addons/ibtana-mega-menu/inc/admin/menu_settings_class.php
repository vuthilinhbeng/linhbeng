...
if ( ! class_exists( 'IEPA_MM_Menu_Settings' ) ) {
  ...
  class IEPA_MM_Menu_Settings {
    ...
    var $iepa_key_arr_license_status  = false;
    /**
     * Constructor
     */
    public function __construct() {
      $this->IEPA_Menu_Settings_get_activation_status();
    ...
    public function IEPA_Menu_Settings_get_activation_status() {
      //
      if ( is_admin() ) {
        ...
        $this->iepa_key_arr_license_status = false;
        if ( $iepa_key_arr ) {
          if ( isset( $iepa_key_arr['license_status'] ) ) {
            if ( true == $iepa_key_arr['license_status'] ) {
              $this->iepa_key_arr_license_status = true;
            }
          }
        }
      }
    ...
    */
    ...
    public function iepa_mm_getlightbox_by_ajax() {
      ...
      if( isset( $_POST ) && $_POST['menu_item_id'] != '' && $_POST['menu_id'] != '' ) {
        ...
        if ( !$this->iepa_key_arr_license_status ) {
          include( IEPA_MM_PATH . 'inc/backend/menu_settings/invalid.php' );
        } else {
